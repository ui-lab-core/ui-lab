...
export const sectionRegistry: SectionRegistry = {
        ...
        "files": [
          {
            "filename": "index.tsx",
            "language": "typescript",
            "code": "\"use client\";\n\nimport React from \"react\";\nimport { Button } from \"ui-lab-components/button\";\nimport { LucideImage, SquareDashed } from \"lucide-react\";\n\nexport function HeroWithCTA() {\n  return (\n    <section className=\"w-full min-h-screen bg-background-950 flex items-center justify-center px-4 py-20\">\n      <div className=\"max-w-6xl mx-auto w-full\">\n        <div className=\"grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center\">\n          <div className=\"space-y-8 order-2 lg:order-1\">\n            <div className=\"inline-flex items-center gap-2 rounded-sm border border-background-700 bg-background-900 px-3 py-1\">\n              <span className=\"h-2 w-2 rounded-sm bg-foreground-400\" />\n              <span className=\"text-sm text-foreground-400\">Now Available</span>\n            </div>\n\n            <div className=\"space-y-4\">\n              <h1 className=\"text-5xl lg:text-6xl font-bold text-foreground-50 leading-tight\">\n                Accelerate Your Development\n              </h1>\n              <p className=\"text-lg text-foreground-300 leading-relaxed\">\n                Comprehensive component library with production-ready code,\n                extensive documentation, and accessibility best practices built\n                in.\n              </p>\n            </div>\n\n            <ul className=\"space-y-3\">\n              {[\n                \"50+ UI Components\",\n                \"TypeScript Support\",\n                \"Fully Customizable\",\n              ].map((feature) => (\n                <li key={feature} className=\"flex items-center gap-3\">\n                  <SquareDashed className=\"h-5 w-5 flex-shrink-0 text-foreground-400\" />\n                  <span className=\"text-foreground-300\">{feature}</span>\n                </li>\n              ))}\n            </ul>\n\n            <div className=\"flex flex-wrap gap-4 pt-4\">\n              <Button variant=\"primary\" size=\"lg\">\n                Start Building\n              </Button>\n              <Button variant=\"secondary\" size=\"lg\">\n                View Docs\n              </Button>\n            </div>\n          </div>\n\n          <div className=\"order-1 lg:order-2\">\n            <div className=\"relative h-96 overflow-hidden rounded-sm bg-background-700\">\n              <LucideImage className=\"absolute inset-0 m-auto text-foreground-400\" />\n            </div>\n          </div>\n        </div>\n      </div>\n    </section>\n  );\n}\n\nexport const metadata = {\n  name: \"Hero with CTA\",\n  description:\n    \"Alternating layout with feature highlights and visual mockup representation\",\n  demoPath: \"hero-with-cta\",\n};\n",
            "isEntryPoint": true
          }
        ]
      },
        ...
        "files": [
          {
            "filename": "index.tsx",
            "language": "typescript",
            "code": "\"use client\";\n\nimport React from \"react\";\nimport { Button } from \"ui-lab-components/button\";\nimport { SquareDashed } from \"lucide-react\";\n\nexport function HeroWithFeatures() {\n  const features = [\n    {\n      title: \"Lightning Fast\",\n      description:\n        \"Optimized performance for blazing fast load times and smooth interactions.\",\n    },\n    {\n      title: \"Secure by Default\",\n      description:\n        \"Enterprise-grade security with built-in protection and compliance standards.\",\n    },\n    {\n      title: \"Production Ready\",\n      description:\n        \"Battle-tested code ready for immediate deployment to production.\",\n    },\n    {\n      title: \"Fully Customizable\",\n      description:\n        \"Extensive configuration options to match your unique brand and requirements.\",\n    },\n  ];\n\n  return (\n    <section className=\"w-full bg-background-950 px-4 py-20\">\n      <div className=\"max-w-6xl mx-auto w-full\">\n        <div className=\"space-y-12\">\n          <div className=\"text-center space-y-6\">\n            <div className=\"inline-flex items-center gap-2 rounded-sm border border-background-700 bg-background-900 px-3 py-1\">\n              <span className=\"h-2 w-2 rounded-sm bg-foreground-400\" />\n              <span className=\"text-sm text-foreground-400\">\n                Powerful Features\n              </span>\n            </div>\n\n            <div className=\"space-y-4\">\n              <h1 className=\"text-5xl lg:text-6xl font-bold text-foreground-50 leading-tight\">\n                Everything You Need to Succeed\n              </h1>\n              <p className=\"text-lg text-foreground-300 max-w-2xl mx-auto leading-relaxed\">\n                Comprehensive toolkit with all the features you need to build\n                amazing applications quickly and efficiently.\n              </p>\n            </div>\n\n            <div className=\"flex flex-wrap gap-4 justify-center pt-4\">\n              <Button variant=\"primary\" size=\"lg\">\n                Start Building\n              </Button>\n              <Button variant=\"secondary\" size=\"lg\">\n                View Documentation\n              </Button>\n            </div>\n          </div>\n\n          <div className=\"grid grid-cols-1 md:grid-cols-2 gap-8 pt-12\">\n            {features.map((feature) => (\n              <div\n                key={feature.title}\n                className=\"rounded-sm border border-background-700 bg-background-900 p-6\"\n              >\n                <div className=\"mb-4 inline-flex rounded-sm bg-background-700 p-3\">\n                  <SquareDashed className=\"h-6 w-6 text-foreground-400\" />\n                </div>\n                <h3 className=\"text-lg font-semibold text-foreground-50 mb-2\">\n                  {feature.title}\n                </h3>\n                <p className=\"text-sm text-foreground-400\">\n                  {feature.description}\n                </p>\n              </div>\n            ))}\n          </div>\n        </div>\n      </div>\n    </section>\n  );\n}\n\nexport const metadata = {\n  name: \"Hero with Features\",\n  description:\n    \"Hero section with feature cards showcasing key benefits and capabilities\",\n  demoPath: \"hero-with-features\",\n};\n",
            "isEntryPoint": true
          }
        ]
      }
  ...
  "cta": {
    ...
    "variants": [
      {
        "name": "Banner CTA",
        "description": "Wide banner call-to-action with a simple monochrome background and dual action buttons",
        "demoPath": "cta-banner",
        "files": [
          {
            "filename": "index.tsx",
            "language": "typescript",
            "code": "\"use client\";\n\nimport React from \"react\";\nimport { Button } from \"ui-lab-components/button\";\nimport { SquareDashed } from \"lucide-react\";\n\nexport function BannerCTA() {\n  return (\n    <section className=\"w-full py-16 px-4 md:py-24\">\n      <div className=\"mx-auto max-w-4xl\">\n        <div className=\"rounded-sm border border-background-700 bg-background-900 px-6 py-12 md:px-12 md:py-16\">\n          <div>\n            <h2 className=\"mx-auto mb-4 max-w-2xl text-3xl font-bold text-foreground-400 md:text-4xl\">\n              Ready to get started?\n            </h2>\n            <p className=\"mx-auto mb-8 max-w-xl text-lg text-foreground-400\">\n              Join thousands of satisfied users and transform the way you work\n              today. No credit card required.\n            </p>\n\n            <div className=\"flex flex-col gap-4 sm:flex-row sm:justify-center\">\n              <Button\n                variant=\"secondary\"\n                size=\"lg\"\n                className=\"group w-full sm:w-auto\"\n              >\n                Get Started Free\n                <SquareDashed className=\"ml-2 h-4 w-4\" />\n              </Button>\n              <Button\n                variant=\"ghost\"\n                size=\"lg\"\n                className=\"w-full border-background-700 sm:w-auto\"\n              >\n                Schedule Demo\n              </Button>\n            </div>\n          </div>\n        </div>\n      </div>\n    </section>\n  );\n}\n\nexport const metadata = {\n  name: \"Banner CTA\",\n  description:\n    \"Wide banner call-to-action with a simple monochrome background and dual action buttons\",\n  demoPath: \"cta-banner\",\n};\n",
            "isEntryPoint": true
          }
        ]
      },
  ...
  "features": {
    ...
    "variants": [
      ...
      {
        "name": "Feature List",
        "description": "Single feature highlight with benefits list and visual",
        "demoPath": "features-list",
        "files": [
          {
            "filename": "index.tsx",
            "language": "typescript",
            "code": "\"use client\";\nimport React from \"react\";\nimport { LucideImage, SquareDashed } from \"lucide-react\";\n\nconst feature = {\n  title: \"Advanced Analytics\",\n  description:\n    \"Gain deep insights into your data with powerful visualization tools and custom reports\",\n  benefits: [\n    \"Real-time dashboards\",\n    \"Custom report builder\",\n    \"Data export in multiple formats\",\n    \"Predictive analytics\",\n  ],\n};\n\nexport function FeatureList() {\n  return (\n    <section className=\"w-full py-16 px-4 md:py-24\">\n      <div className=\"mx-auto max-w-6xl\">\n        <div className=\"grid gap-8 md:gap-12 md:grid-cols-2 items-center\">\n          <div>\n            <h3 className=\"mb-4 text-md font-bold text-foreground-400 md:text-3xl\">\n              {feature.title}\n            </h3>\n            <p className=\"mb-6 text-lg text-foreground-400\">\n              {feature.description}\n            </p>\n            <ul className=\"space-y-3\">\n              {feature.benefits.map((benefit, i) => (\n                <li key={i} className=\"flex items-center gap-3\">\n                  <SquareDashed className=\"h-5 w-5 flex-shrink-0 text-foreground-400\" />\n                  <span className=\"text-foreground-400\">{benefit}</span>\n                </li>\n              ))}\n            </ul>\n          </div>\n          <div className=\"relative\">\n            <div className=\"h-100 relative overflow-hidden rounded-sm bg-background-700 p-8\">\n              <LucideImage className=\"text-foreground-400 absolute inset-0 m-auto\" />\n            </div>\n          </div>\n        </div>\n      </div>\n    </section>\n  );\n}\n\nexport const metadata = {\n  name: \"Feature List\",\n  description: \"Single feature highlight with benefits list and visual\",\n  demoPath: \"features-list\",\n};\n",
            "isEntryPoint": true
          }
        ]
      }
