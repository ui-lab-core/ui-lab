...
export function getPreview(): React.ReactNode {
  return (
    <div style={{ width: "60%" }} className="relative rounded-base">
      <div className='w-full rounded-base bg-background-700 border border-background-600 left-0 absolute h-3' />
