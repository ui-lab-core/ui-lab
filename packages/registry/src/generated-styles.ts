...
export const generatedStyles: Record<string, { rawCss: string; styleableParts: Array<{ name: string }>; cssVariables: Array<{ name: string; value: string; defaultValue?: string; referencedVars: string[]; variant?: string | null }> }> = {
  ...
  "slider": {
    "rawCss": "@reference \"tailwindcss\";\n\n@layer components.defaults {\n  .slider {\n    --disabled-opacity: 0.6;\n    @apply relative flex w-full items-center;\n    min-inline-size: var(--inline-size, 12rem);\n    min-height: var(--hit-size, var(--slider-hit-size, 2rem));\n    touch-action: none;\n    user-select: none;\n  }\n\n  .track {\n    --thickness: var(--size, var(--slider-track-size, calc(var(--spacing-md) * 0.80)));\n    --length: calc(var(--thickness) * var(--ratio, 0.666667));\n    @apply relative flex grow items-center;\n    flex-grow: 1;\n    height: var(--thickness);\n    overflow: visible;\n    border-radius: var(--radius, var(--slider-track-radius, calc(var(--spacing-xs) * 0.50)));\n    border: var(--border, var(--slider-track-border, 0));\n    background: var(--track-background, var(--slider-track-background, var(--background)));\n  }\n\n  .range {\n    @apply absolute;\n    display: var(--range-display, var(--slider-range-display, block));\n    border-radius: inherit;\n    pointer-events: none;\n    background: var(--range-background, var(--slider-range-background, var(--background)));\n    transition:\n      background-color var(--hover-duration, var(--hover-leave-duration, 300ms)) var(--hover-transition-timing-function, var(--ease-snappy-pop, ease-out));\n  }\n\n  .thumb {\n    --thumb-inline-size: var(--thumb-width, var(--thumb-size, var(--slider-thumb-size, var(--width, var(--length)))));\n    --thumb-block-size: var(--thumb-height, var(--thumb-size, var(--slider-thumb-size, var(--height, 100%))));\n\n    @apply absolute block;\n    top: var(--top, 0);\n    box-sizing: border-box;\n    width: var(--thumb-inline-size);\n    height: var(--thumb-block-size);\n    transform: var(--transform, translateX(-50%));\n    border-radius: var(--thumb-radius, var(--radius, calc(var(--spacing-xs) * 0.35)));\n    outline: none;\n    background: var(--thumb-background, var(--slider-thumb-background, var(--background)));\n    border: var(--thumb-border, var(--slider-thumb-border, none));\n    box-shadow: var(--thumb-shadow, var(--slider-thumb-shadow, none));\n    transition:\n      background-color var(--hover-duration, var(--hover-leave-duration, 300ms)) var(--hover-transition-timing-function, var(--ease-snappy-pop, ease-out)),\n      border-color var(--hover-duration, var(--hover-leave-duration, 300ms)) var(--hover-transition-timing-function, var(--ease-snappy-pop, ease-out)),\n      box-shadow var(--hover-duration, var(--hover-leave-duration, 300ms)) var(--hover-transition-timing-function, var(--ease-snappy-pop, ease-out)),\n      transform var(--hover-duration, var(--hover-leave-duration, 300ms)) var(--hover-transition-timing-function, var(--ease-snappy-pop, ease-out));\n  }\n\n  .slider[data-orientation=\"horizontal\"] .range {\n    top: 0;\n    height: 100%;\n  }\n\n  .slider[data-orientation=\"horizontal\"] .thumb {\n    left: clamp(\n      var(--thumb-inset, 0px),\n      var(--position, 0%),\n      calc(100% - var(--thumb-inset, 0px))\n    );\n  }\n\n  .slider[data-orientation=\"vertical\"] {\n    justify-content: center;\n    min-inline-size: auto;\n    width: fit-content;\n  }\n\n  .slider[data-orientation=\"vertical\"] .track {\n    width: var(--thickness);\n    height: 100%;\n  }\n\n  .slider[data-orientation=\"vertical\"] .range {\n    left: 0;\n    width: 100%;\n  }\n\n  .slider[data-orientation=\"vertical\"] .thumb {\n    left: 50%;\n    top: auto;\n    bottom: clamp(\n      var(--thumb-inset, 0px),\n      var(--position, 0%),\n      calc(100% - var(--thumb-inset, 0px))\n    );\n    width: var(--thumb-block-size);\n    height: var(--thumb-inline-size);\n    transform: translate(-50%, 50%);\n  }\n\n  .slider[data-disabled=\"true\"] {\n    opacity: var(--disabled-opacity);\n    cursor: not-allowed;\n  }\n\n  .slider[data-disabled=\"true\"] .range {\n    background: var(--disabled-background, var(--range-background, var(--slider-range-background, var(--background))));\n  }\n\n  .thumb[data-disabled=\"true\"] {\n    cursor: not-allowed;\n    background: var(--disabled-background, var(--thumb-background, var(--slider-thumb-background, var(--background))));\n  }\n\n  .thumb[data-pressed=\"true\"] {\n    transform: var(--transform, translateX(-50%));\n  }\n\n  .slider[data-orientation=\"vertical\"] .thumb[data-pressed=\"true\"] {\n    transform: translate(-50%, 50%);\n  }\n}\n",
    "styleableParts": [
      {
        "name": "root"
      },
    ...
    "cssVariables": [
      ...
      {
        "name": "--thickness",
        "value": "var(--size, var(--slider-track-size, calc(var(--spacing-md) * 0.80)))",
        "defaultValue": "var(--slider-track-size, calc(var(--spacing-md",
        "referencedVars": [
          "--size"
        ],
        "variant": ".track"
      ...
      {
        "name": "--length",
        "value": "calc(var(--thickness) * var(--ratio, 0.666667))",
      ...
      {
        "name": "--thumb-inline-size",
        "value": "var(--thumb-width, var(--thumb-size, var(--slider-thumb-size, var(--width, var(--length)))))",
        "defaultValue": "var(--thumb-size, var(--slider-thumb-size, var(--width, var(--length",
        "referencedVars": [
          "--thumb-width"
        ],
        "variant": ".thumb"
      ...
      {
        "name": "--thumb-block-size",
        "value": "var(--thumb-height, var(--thumb-size, var(--slider-thumb-size, var(--height, 100%))))",
        "defaultValue": "var(--thumb-size, var(--slider-thumb-size, var(--height, 100%",
        "referencedVars": [
          "--thumb-height"
        ],
        "variant": ".thumb"
  ...
  "skeleton": {
    "rawCss": "@reference \"tailwindcss\";\n\n@layer components.defaults {\n  .shape {\n    display: block;\n    background: var(--background, var(--background-800));\n    border-radius: var(--radius, var(--radius-sm, 0.375rem));\n  }\n\n  .rectangle {\n    width: var(--width, 10rem);\n    height: var(--height, 0.75rem);\n  }\n\n  .text {\n    display: flex;\n    width: 100%;\n    flex-direction: column;\n    gap: calc(var(--gap, 0.375rem) * var(--scale, 1));\n    align-content: start;\n  }\n\n  .text[data-size=\"body\"] {\n    --row-height: 0.75rem;\n    --gap: 0.375rem;\n  }\n\n  .text[data-size=\"heading\"] {\n    --row-height: 1.25rem;\n    --gap: 0.5rem;\n  }\n\n  .text[data-size=\"display\"] {\n    --row-height: 2rem;\n    --gap: 0.625rem;\n  }\n\n  .row {\n    width: 100%;\n    height: calc(var(--row-height, 0.75rem) * var(--scale, 1));\n    flex: none;\n  }\n\n  .lastRow {\n    width: var(--last-line-width, 70%);\n  }\n\n  .image {\n    width: var(--width, 100%);\n    height: auto;\n    aspect-ratio: var(--ratio, 16 / 9);\n  }\n\n  :global(.skeleton) {\n    animation: none;\n  }\n\n  :global([data-skeleton-animate]) :global(.skeleton) {\n    animation: var(--animation, none);\n  }\n\n  @media (prefers-reduced-motion: reduce) {\n    :global([data-skeleton-animate]) :global(.skeleton) {\n      animation: none !important;\n    }\n  }\n}\n",
    "styleableParts": [],
    "cssVariables": [
      {
        "name": "--row-height",
      ...
      },
      {
        ...
        "defaultValue": null,
        "referencedVars": [],
        "variant": ".text[data-size=\"heading\"]"
      },
      {
        "name": "--gap",
        "value": "0.5rem",
      ...
      },
      {
        ...
        "defaultValue": null,
        "referencedVars": [],
        "variant": ".text[data-size=\"display\"]"
      },
      {
        "name": "--gap",
        "value": "0.625rem",
  ...
  "select": {
    ...
    "cssVariables": [
      ...
      {
        "name": "--background",
        "value": "var(--trigger-background-hover, transparent)",
  ...
  "progress": {
    ...
    "cssVariables": [
      {
        "name": "--thickness",
        "value": "var(--size, calc(var(--spacing-md) * 0.80))",
        "defaultValue": "calc(var(--spacing-md",
        "referencedVars": [
          "--size"
        ],
        "variant": ".track"
  ...
  "menu": {
    ...
    "cssVariables": [
      ...
      },
      {
        ...
        "variant": ":global(.menu) .trigger[data-hovered=\"true\"]"
      },
      {
        "name": "--hover-duration",
        "value": "var(--hover-enter-duration, 0ms)",
        ...
        "variant": ":global(.menu) .item[data-highlighted=\"true\"]"
      },
      {
        "name": "--hover-duration",
        "value": "var(--hover-enter-duration, 0ms)",
        ...
        "variant": ":global(.menu) .sub-trigger[data-highlighted=\"true\"],\n      :global(.menu) .sub-trigger[data-state=\"open\"]:not([data-highlighted=\"true\"])"
      }
    ]
  },
  "mask": {
  ...
  "group": {
    ...
    "cssVariables": [
      ...
      {
        "name": "--size",
        "value": "var(--item-height)",
        "defaultValue": null,
        "referencedVars": [
          "--item-height"
        ],
        "variant": ".item.icon-button-item .button:global(.icon)"
      },
      {
        "name": "--hover-duration",
        "value": "var(--hover-enter-duration, 0ms)",
        ...
        "variant": ".select > :global(.value):has(> :global(.button[data-hovered=\"true\"]:not([data-disabled=\"true\"])))"
      },
      {
        "name": "--background",
        "value": "var(--background-border)",
        ...
        "variant": ".group .item [role=\"separator\"]"
      },
      {
        "name": "--background-radius",
        "value": "0",
  ...
  "grid": {
    ...
    "cssVariables": [
      ...
      {
        "name": "--grid-masonry-gap",
        "value": "calc(var(--spacing, 0.25rem) * var(--grid-col-gap-step, var(--grid-gap-step, 4)) * var(--gap-scale, 1))",
        "defaultValue": "0.25rem",
        "referencedVars": [
          "--spacing",
          "--grid-col-gap-step",
        ...
        "variant": ".grid.masonry.masonry-fixed-width"
      },
      {
        "name": "--grid-masonry-col-width",
        "value": "var(--grid-masonry-col-width-sm, auto)",
        "defaultValue": "auto",
        "referencedVars": [
          "--grid-masonry-col-width-sm"
        ],
        "variant": ".grid.masonry.responsive-masonry-width"
      },
      {
        "name": "--grid-masonry-col-width",
        "value": "var(--grid-masonry-col-width-md, var(--grid-masonry-col-width-sm, auto))",
        "defaultValue": "var(--grid-masonry-col-width-sm, auto",
        "referencedVars": [
          "--grid-masonry-col-width-md"
        ],
        "variant": ".grid.masonry.responsive-masonry-width"
      },
      {
        "name": "--grid-masonry-col-width",
        "value": "var(--grid-masonry-col-width-lg, var(--grid-masonry-col-width-md, var(--grid-masonry-col-width-sm, auto)))",
        "defaultValue": "var(--grid-masonry-col-width-md, var(--grid-masonry-col-width-sm, auto",
        "referencedVars": [
          "--grid-masonry-col-width-lg"
        ],
        "variant": ".grid.masonry.responsive-masonry-width"
      },
      {
        "name": "--grid-masonry-col-width",
        "value": "var(--grid-masonry-col-width-xl, var(--grid-masonry-col-width-lg, var(--grid-masonry-col-width-md, var(--grid-masonry-col-width-sm, auto))))",
        "defaultValue": "var(--grid-masonry-col-width-lg, var(--grid-masonry-col-width-md, var(--grid-masonry-col-width-sm, auto",
        "referencedVars": [
          "--grid-masonry-col-width-xl"
        ],
        "variant": ".grid.masonry.responsive-masonry-width"
      }
    ]
  ...
  "gallery": {
    ...
    "cssVariables": [
      ...
      {
        "name": "--transition",
        "value": "var(--hover-duration, var(--hover-leave-duration, 300ms)) var(--hover-transition-timing-function, var(--ease-snappy-pop, ease-out))",
        "defaultValue": "var(--hover-leave-duration, 300ms",
        "referencedVars": [
          "--hover-duration",
  ...
  "divider": {
    "rawCss": "@reference \"tailwindcss\";\n\n@layer components.defaults {\n  .divider {\n    --background: var(--background-border, currentColor);\n  }\n}\n",
    "styleableParts": [
      {
        "name": "root"
      }
    ...
    "cssVariables": [
      {
        "name": "--background",
        "value": "var(--background-border, currentColor)",
  ...
  "color": {
    ...
    "cssVariables": [
      ...
      {
        "name": "--track-height",
        "value": "calc(var(--spacing, 0.25rem) * 5)",
        "defaultValue": "0.25rem",
        "referencedVars": [
          "--spacing"
        ],
      ...
      {
        "name": "--padding-block",
        "value": "var(--padding, calc(var(--spacing, 0.25rem) * 0.5))",
        "defaultValue": "calc(var(--spacing, 0.25rem",
        "referencedVars": [
          "--padding"
        ],
        "variant": ".hue-slider"
      ...
      {
        "name": "--thumb-width",
        "value": "calc(var(--track-height) - (var(--padding-block) * 2))",
        "defaultValue": null,
        "referencedVars": [
          "--track-height",
          "--padding-block"
      ...
      {
        "name": "--thumb-inset",
        "value": "calc(var(--side-padding) + (var(--thumb-width) / 2))",
        "defaultValue": null,
        "referencedVars": [
          "--side-padding",
          "--thumb-width"
      ...
      {
        "name": "--thumb-shadow",
        "value": "0 0 0 1px rgb(0 0 0 / 0.28)",
        "defaultValue": null,
        "referencedVars": [],
        "variant": ".hue-slider"
      },
      ...
      {
        "name": "--thumb-shadow-hover",
        "value": "0 0 0 1px rgb(0 0 0 / 0.38)",
        "defaultValue": null,
        "referencedVars": [],
        "variant": ".hue-slider .hue-thumb"
      },
      {
        "name": "--thumb-shadow-active",
        "value": "0 0 0 1px rgb(0 0 0 / 0.24)",
        "defaultValue": null,
        "referencedVars": [],
        "variant": ".hue-slider .hue-thumb"
      },
      {
        "name": "--size",
        "value": "calc(var(--spacing, 0.25rem) * 4)",
        "defaultValue": "0.25rem",
        "referencedVars": [
          "--spacing"
        ],
      ...
      {
        "name": "--thumb-width",
        "value": "calc(var(--size) - (var(--padding-block) * 2))",
        "defaultValue": null,
        "referencedVars": [
          "--size",
          "--padding-block"
      ...
      {
        "name": "--padding-inline",
        "value": "var(--inline-padding, var(--padding-block))",
        "defaultValue": "var(--padding-block",
        "referencedVars": [
          "--inline-padding"
        ],
        "variant": ".opacity-slider"
  ...
  "chart": {
    ...
    "cssVariables": [
      ...
      },
      {
        ...
        "defaultValue": null,
        "referencedVars": [],
        "variant": ":global([data-theme=\"light\"]) .chart"
      },
      {
        "name": "--color-2",
        "value": "#008300",
