...
export const generatedStyles: Record<string, { rawCss: string; styleableParts: Array<{ name: string }>; cssVariables: Array<{ name: string; value: string; defaultValue?: string; referencedVars: string[]; variant?: string | null }> }> = {
  ...
  "group": {
    ...
    "cssVariables": [
      ...
      {
        "name": "--control-height",
        "value": "calc((1em * var(--leading-tight, 1.25)) + (var(--spacing) * 4) + (var(--group-border-width) * 2))",
        "defaultValue": "1.25",
        "referencedVars": [
          "--leading-tight",
          "--spacing",
      ...
      {
        "name": "--item-height",
        "value": "max(calc(var(--control-height) - (var(--padding) * 2) - (var(--group-border-width) * 2)), 0px)",
        "defaultValue": null,
        "referencedVars": [
          "--control-height",
          "--padding",
      ...
      },
      {
        ...
        "value": "max(calc(var(--spacing) * 2.5 - var(--padding)), 0px)",
        "defaultValue": null,
        "referencedVars": [
          "--spacing",
          "--padding"
      ...
      },
      {
        ...
        "value": "max(calc(var(--spacing) * 2 - var(--padding)), 0px)",
        "defaultValue": null,
        "referencedVars": [
          "--spacing",
          "--padding"
      ...
      },
      {
        ...
        "value": "max(calc(var(--spacing) * 3 - var(--padding)), 0px)",
        "defaultValue": null,
        "referencedVars": [
          "--spacing",
          "--padding"
      ...
      },
      {
        ...
        "value": "max(calc(var(--spacing) * 1.5 - var(--padding)), 0px)",
        "defaultValue": null,
        "referencedVars": [
          "--spacing",
          "--padding"
