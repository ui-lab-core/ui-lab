...
export function PatternDetailContent({
  patternId,
  pattern,
        ...
        {pattern.code && (
          <div className="mb-10">
            <PreviewCodeDisplay
              code={pattern.code}
              language="tsx"
              previewContent={<PatternLivePreview scope="pattern" id={patternId} />}
                ...
                return (
                  <div key={variation.id}>
                    ...
                    <PreviewCodeDisplay
                      code={variation.code}
                      language="tsx"
                      previewContent={<PatternLivePreview scope="variation" id={variation.id} />}
