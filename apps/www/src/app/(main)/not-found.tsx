    ...
    <ClientShell docsNavigationData={docsNavigationData}>
      <article className="w-full pt-16 flex flex-col md:flex-row">
        ...
        <main className="flex w-full min-h-screen items-center justify-center px-4 text-foreground-50">
          <div className="flex items-center gap-4 text-center  text-foreground-300">
            <span className="font-bold text-2xl flex items-center"><div className="mr-[-2px]">4</div><Logo className="h-11 w-11" /><span className="ml-[-4px]">4</span></span>
            <Divider orientation="vertical" styles="my-2" />
