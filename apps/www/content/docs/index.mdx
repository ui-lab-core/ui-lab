...
<Banner>
  ...
  <Banner.Body>
    UI Lab is currently in early development. Features and APIs may change. If you encounter any issues or have feedback, please let us know by creating an issue in our [repository](https://github.com/ui-lab-core/ui-lab).
  </Banner.Body>
</Banner>
...
Then add your app-owned token layer and import `ui-lab-components/styles.css`. Follow the [Installation guide](/docs/installation) for the required stylesheet order and a complete working setup.
...
<div className="background-800 foreground-100 border-700">

// Wrong — breaks dark mode and design system
<div className="flex bg-slate-900 text-gray-100 border border-slate-800">
```
...
- [Explore Elements](/workshop/elements) — multi-component UI blocks
...
- [GitHub](https://github.com/ui-lab-core/ui-lab) — source, issues, releases
