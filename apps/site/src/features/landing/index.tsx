...
//     <>
//       <div className="z-10 mt-12 sm:mt-0 overflow-hidden">
//         <div className="relative h-full flex items-center justify-between md:justify-center">
...
//             </p>
//           </div>
//           <div className="border  border-background-700 mx-auto w-auto h-90 rounded-md my-24 aspect-video bg-background-900">
//
//           </div>
//         </div>
//       </div>
