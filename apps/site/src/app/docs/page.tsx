...
const ReactAriaSvg = () => (
  <svg width="91" height="80" viewBox="0 0 91 80" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8">
    <g clipPath="url(#clip0_906_1839)">
      <path d="M56.9686 0H90.4318V80L56.9686 0Z" fill="var(--background-500)" />
      <path d="M33.4632 0H0V80L33.4632 0Z" fill="var(--background-500)" />
      <path d="M45.1821 29.4668L66.5199 80.0002H52.5657L46.1982 63.9461H30.6182L45.1821 29.4668Z" fill="var(--background-500)" />
    </g>
    <defs>
