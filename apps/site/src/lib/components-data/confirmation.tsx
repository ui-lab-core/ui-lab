...
// Control definitions for the confirmation configurator
const confirmationControls: ControlDef[] = [
  {
    name: "severity",
    label: "Severity",
    type: "select",
  ...
  },
  {
    ...
    type: "select",
    options: [
      { label: "Auto (by severity)", value: "auto" },
...
export const confirmationComponentDetail: ComponentDetail = {
  id: "confirmation",
  name: "Confirmation",
