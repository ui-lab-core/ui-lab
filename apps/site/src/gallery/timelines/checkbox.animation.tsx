...
export function CheckboxAnimation() {
  ...
  const cursor = {
    idle: {
      transform: "translate(240px, 220px) rotate(15deg) scale(1.2)",
      opacity: 0,
    },
    hover: {
      transform: `translate(90px, ${activeRowY + 28}px) rotate(-15deg) scale(1.1)`,
      opacity: 1,
    },
  };
