...
|--------|---------|----------|
| **Background** | Surface and container colors | Page backgrounds, borders, cards, elevated surfaces |
| **Foreground** | Text and icon colors | Body text, labels, icons |
...
- **Usage**: Page backgrounds, card surfaces, elevated containers, borders, dividers
