...
- <Anchor href="/design-system/colors">Colors</Anchor> — full OKLCH palette reference with all shade values
- <Anchor href="/design-system/tokens">Design Tokens</Anchor> — complete token reference for spacing, typography, and motion
- <Anchor href="/design-system/variables">Variables</Anchor> — all CSS custom properties and their defaults
